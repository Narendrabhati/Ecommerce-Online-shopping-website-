    ...
    <div class="panel">
        <div class="panel-body">
            <div class="thumb-info mb-md">
                <img src="images/<?php echo $admin_image ?>" class="rounded img-responsive">
            ...
            <div class="mb-md">
                <div class="widget-content-expanded">
                    ...
                    <i class="fa fa-globe"></i> <span>Country: </span> <?php echo $admin_country ?> <br>
                    <i class="fa fa-address-book"></i> <span>Contact: </span> <?php echo $admin_contact ?> <br>
                </div>
